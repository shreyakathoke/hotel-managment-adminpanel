    ...
    <div className="container-fluid px-3 px-lg-4 py-4 bookings-page">
      <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
        ...
        <div className="d-flex flex-column flex-sm-row gap-2">
          <input
            className="form-control bookings-search"
            placeholder="Search by name, email, room, payment id..."
            value={q}
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-12 col-md-6 col-xl-3">
          <div className="card soft-card p-3">
            <div className="text-muted small">Payments Success</div>
            <div className="kpi-value">{kpis.successPay}</div>
          </div>
        </div>
      </div>
        ...
        <div className="modal-backdrop-custom" onClick={() => setSelected(null)}>
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            <div className="modal-card-header">
              ...
              <button className="btn btn-light btn-sm" onClick={() => setSelected(null)}>
              ...
              <div className="row g-3">
                <div className="col-12 col-md-6">
                  <div className="detail-box">
                    ...
                    <div className="detail-value">{safe(selected.userName)}</div>
                    <div className="text-muted small">{safe(selected.userEmail)}</div>
                ...
                <div className="col-12 col-md-6">
                  <div className="detail-box">
                    ...
                    <div className="detail-value">{safe(selected.address)}</div>
